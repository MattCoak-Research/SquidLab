...
function V = dipoleEquation(a, c, z)
...
% - c(2) is the offset of the sample with respect to z = 0.
%
...
V = c(1) .* (2.* iPointDipole(a(1), 0, c(2), z) - ...
    iPointDipole(a(1), a(2), c(2), z) - iPointDipole(a(1), -a(2), c(2), z));

end

function v = iPointDipole(radius, separation, offset, z)

v = (radius.^2 + (offset+separation+z).^2).^(-3/2);
end