...
function V = driftingDipoleEquationFixedCentre(a, c, z)
% New functionality added Mar2024 M Coak - modified version of the
% driftingDipole equation with the centre fixed at z=0, rather than
...
% Add linear drift and offset to the simple dipole form with fixed centre.
V = c(1) + c(2).*z + ...
    squidlab.fit.dipoleEquationFixedCentre(a, c(3), z);
end