...
classdef MPMS_IQuantum_MvH < squidlab.import.ImportPipeline
    ...
    methods (Access = protected)
        function [meta] = GetMetaData(this)
            ...
            meta.CryostatInfo = 'MPMS IQuantum He-3 option, standard format, MvH';
        end
    end
    ...
    methods(Access = public)
        ...
        function [results, info] = process(this, fileName, scaleFactor)
            ...
            % Results to return.
            results.Temperatures = fields;  %Yep, this is deliberately switched for the MvH importer - MvH just stores a 'temperature' equal to the field value!
