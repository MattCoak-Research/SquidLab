...
classdef MPMSXL_MvH < squidlab.import.ImportPipeline
    %Import pipeline for M vs H sweeps for an old generation MPMS XL datafile, which doesnt
    ...
    methods(Access = protected)
        ...
        function [meta] = GetMetaData(this)
            ...
            meta.CryostatInfo = 'MPMS or MPMSXL, standard format, MvH';
        end
    end
    ...
    methods(Access = public)        
        ...
        function [results, info] = process(this, fileName, scaleFactor)
            ...
            % Reads the data in the file  and returns a
    ...
    methods(Access = protected)
        ...
        function pointsInScan = getNumberOfPointsInScan(~, positionsArray)
            %Position values in a single scan ramp up contiusoly, then
