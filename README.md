...
<img width="624" height="446" alt="image" src="https://github.com/user-attachments/assets/f035032f-076c-4465-bec1-0c6a1b2b6a7a" />
...
<img width="1688" height="999" alt="image" src="https://github.com/user-attachments/assets/362781a2-7b8f-4f7e-ad4b-d415c928f9a9" />
...
[SquidLab Installer - Web](Release/Package/SquidLab Installer - Runtime Web Installer.exe) - download and run. The installer will download and install the MATLAB Runtime automatically.

#### No Runtime (standalone installer)
[SquidLab Installer - No Runtime](Release/Package/SquidLab Installer - No Runtime.exe) - download and run. The MATLAB Runtime must be installed on your computer for the programme to then launch, it can be downloaded from Mathworks [here](https://uk.mathworks.com/products/compiler/matlab-runtime.html)
